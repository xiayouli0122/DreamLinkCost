...
public class CardViewAdapter2 extends RecyclerView.Adapter<CardViewAdapter2.ViewHolder> {
    ...
    public CardViewAdapter2(List<Cost> list, MainFragment mainFragment) {
        this.mCostList = list;
    }
...
//        notifyItemRangeInserted(0, mCostList.size() - 1);
    ...
    @Override
    public CardViewAdapter2.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
